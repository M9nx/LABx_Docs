...
if ($conn->multi_query($sql)) {
    ...
    <head>
        ...
        <title>Setup Complete - Lab 11</title>
        <style>
    ...
    <body>
        <div class='setup-box'>
            ...
            <p>Lab 11 database has been created successfully.</p>
            <div class='credentials'>
                <strong>Admin:</strong> administrator:admin<br>
                <strong>Test User:</strong> wiener:peter
            </div>
