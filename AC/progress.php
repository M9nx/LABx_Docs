<?php
/**
 * Access Control Category - Progress Helper
 * Provides lab progress tracking functions for all AC labs
 */
...
function markLabSolved($labNumber) {
    ...
    if ($conn->connect_error) {
        ...
        $conn->query("CREATE DATABASE IF NOT EXISTS ac_progress");
        $conn->select_db('ac_progress');
 ...
 */
function getProgressStats($totalLabs = 30) {
