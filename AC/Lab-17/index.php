...
<head>
    ...
    <title>Lab 17 - IDOR External Status Check Disclosure</title>
    <style>
...
<body>
    ...
    <div class="container">
        <div class="hero">
            <span class="lab-badge">Lab 17 • Practitioner</span>
            <h1>🔓 IDOR External Status Check Disclosure</h1>
            <p>Exploit an API endpoint vulnerability to access sensitive configuration data from private projects across the entire GitLab instance.</p>
        </div>
        ...
        <div class="scenario-card">
            <h2>🎯 Lab Scenario</h2>
            <p>
                This lab simulates a GitLab instance with the <strong>External Status Checks</strong> feature. 
                When configured, projects send merge request information to external validation endpoints before merging.
                The API endpoint <code>/api/status_check_responses</code> contains an IDOR vulnerability - the 
                <code>external_status_check_id</code> parameter is not restricted to status checks belonging to 
                the current project, allowing attackers to leak sensitive information about ANY status check on the instance.
            </p>
            ...
            <div class="leaked-data">
                ...
                <ul>
                    ...
                    <li>External status check URLs (internal infrastructure)</li>
                    <li>API keys and webhook secrets</li>
                    <li>Protected branch configurations</li>
                    <li>User access levels and names</li>
                </ul>
            </div>
        </div>
        ...
        <div class="scenario-card">
            ...
            <div class="attack-flow">
                <div class="attack-step">
                    ...
                    <p>Login as attacker and create a project with status check</p>
                </div>
                <div class="attack-step">
                    <div class="step-num">2</div>
                    <h4>Create MR</h4>
                    <p>Open a merge request in your project</p>
                </div>
                <div class="attack-step">
                ...
                <div class="attack-step">
                    ...
                    <h4>Exploit IDOR</h4>
                    <p>Change external_status_check_id to leak data</p>
                </div>
            </div>

            <h3 style="color: #fc6d26; margin: 1.5rem 0 1rem;">Vulnerable API Request:</h3>
            <div class="vulnerable-request">
<span class="comment"># The attacker changes external_status_check_id from their own (5) to victim's (1)</span>
POST /api/status_check_responses.php HTTP/1.1
Host: localhost
Authorization: Bearer glpat-attacker-token-xyz789

project_id=3&merge_request_iid=1&sha=x9y8z7...&<span class="param">external_status_check_id=1</span>

<span class="comment"># API returns victim's private status check configuration!</span>
            </div>
        </div>
        ...
        <div class="scenario-card">
            ...
            <div class="credential-grid">
                <div class="credential-card">
                    ...
                    <h4>victim01</h4>
                    <code>victim01 / victim123</code>
                    <p style="color: #888; font-size: 0.85rem; margin-top: 0.5rem;">
                        Owns private project with sensitive status checks
                    </p>
                </div>
                <div class="credential-card">
                    <span class="role attacker">Attacker ⭐</span>
                    <h4>attacker01</h4>
                    <code>attacker01 / attacker123</code>
                    <p style="color: #888; font-size: 0.85rem; margin-top: 0.5rem;">
