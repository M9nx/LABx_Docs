...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hint-box h4 { color: #fc6d26; margin-bottom: 0.25rem; }
        .hint-box p { color: #aaa; margin: 0; }
    ...
    <main class="main-content">
        <div class="login-container">
            <div class="login-form">
                <h1>🔐 Sign In</h1>
                <p class="subtitle">Access SnippetHub Platform</p>
            ...
            <div class="credentials-panel">
                ...
                <div class="cred-card victim" onclick="fillCredentials('victim', 'victim123')">
                    <div class="cred-header">
                        <span class="cred-username">victim</span>
                        <span class="cred-role victim">Victim</span>
                    </div>
                    <div class="cred-password">victim123</div>
                    <div class="cred-desc">🔒 Has 5 private personal snippets</div>
                </div>
                
                <div class="cred-card user" onclick="fillCredentials('alice', 'alice123')">
                    <div class="cred-header">
                ...
                <div class="cred-card user" onclick="fillCredentials('admin', 'admin123')">
                    <div class="cred-header">
                ...
                <div class="hint-box">
                    <h4>💡 Hint</h4>
                    <p>Login as <strong>attacker</strong> and create a note on your issue. Then intercept and modify the request!</p>
                </div>
            </div>
        </div>
    </main>
