...
<body>
    ...
    <div class="container">
        <div class="hero">
            ...
            <p>Lab 10: URL-based access control can be circumvented</p>
        </div>
        ...
        <div class="status-box">
            ...
            <p style="margin-top: 0.5rem;">However, the back-end application supports the <strong>X-Original-URL</strong> header.</p>
            <p style="margin-top: 0.5rem;">Goal: Access the admin panel and <strong>delete the user carlos</strong>.</p>
        ...
        <div class="blocked-notice">
            <h3>🚫 Admin Panel Access Blocked</h3>
            <p>Direct access to <code>/admin</code> is blocked by the front-end security system.</p>
            <p style="margin-top: 0.5rem; font-size: 0.9rem;">But is there another way to reach it?</p>
        </div>
        ...
        <div class="features">
            ...
            <div class="feature-card">
                <h3>🛡️ Front-End Security</h3>
                <p>A proxy blocks direct access to sensitive admin paths like /admin.</p>
            </div>
            <div class="feature-card">
                <h3>⚠️ Header Processing</h3>
                <p>The back-end framework processes certain HTTP headers for URL routing.</p>
            </div>
        </div>
