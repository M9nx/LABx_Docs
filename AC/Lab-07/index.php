...
<body>
    ...
    <div class="container">
        <div class="hero">
            <h1>🔄 RedirectLab</h1>
            <p>Lab 7: User ID controlled by request parameter with data leakage in redirect</p>
        ...
        <div class="status-box">
            <h3>🎯 Lab Objective</h3>
            <p>Obtain the API key for user <strong>carlos</strong> by exploiting data leakage in redirect responses.</p>
        ...
        <div class="features">
            <div class="feature-card">
                ...
                <p>Login to access your personal account page with your unique API key.</p>
            </div>
            <div class="feature-card">
                <h3>🔑 API Key Management</h3>
                <p>Each user has a unique API key displayed on their profile page.</p>
            </div>
            <div class="feature-card">
                <h3>⚠️ Redirect Vulnerability</h3>
                <p>The profile page has a security flaw where sensitive data leaks in redirect responses.</p>
            </div>
        </div>
